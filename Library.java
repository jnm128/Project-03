...
public class Library {
  ...
  public boolean checkout(long isbn, String holder, int month, int day, int year) {
	  GregorianCalendar dueDate= new GregorianCalendar( year, month,day);
		 ...
		 for(int i = 0; i < this.library.size(); i++) {
			 if (this.library.get(i).getIsbn() == isbn && this.library.get(i).getHolder()==null) 
			 {
				 this.library.get(i).checkout(holder, dueDate);
				  return true;
			 }
		 }
  ...
  public ArrayList<LibraryBook> lookup(String holder) {
    // FILL IN -- do not return null
	 ArrayList <LibraryBook> holders = new ArrayList <LibraryBook>();
	 for (int i=0; i< this.library.size();i++) {
		 if (this.library.get(i).getHolder()!= null){
			 if(this.library.get(i).getHolder().equals(holder)){	 
			 holders.add(this.library.get(i));
		 }
	 }
	 }
	 return holders;
  ...
  public boolean checkin(String holder) {
	    // *FILL IN -- do not return false unless appropriate	
		 ...
		 for(int i = 0; i < this.library.size(); i++) {
			 if (this.library.get(i).getHolder() == holder && this.library.get(i).getHolder()!=null) 
			 {
				 this.library.get(i).checkin();
				  return true;
			 }
